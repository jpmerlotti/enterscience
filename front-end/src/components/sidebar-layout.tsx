  ...
  return (
    <Headless.Dialog open={open} onClose={close} className="lg:hidden">
      ...
      <Headless.DialogPanel
        transition
        className="fixed inset-y-0 w-full p-2 transition duration-300 ease-in-out max-w-80 data-closed:-translate-x-full"
      >
...
export function SidebarLayout({
  ...
  return (
    <div className="relative flex w-full bg-white isolate min-h-svh max-lg:flex-col lg:bg-zinc-100 dark:bg-zinc-900 dark:lg:bg-zinc-950">
      {/* Sidebar on desktop */}
      <div className="fixed inset-y-0 left-0 w-[350px] max-lg:hidden">{sidebar}</div>
      ...
      {/* Content */}
      <main className="flex flex-col flex-1 pb-2 lg:min-w-0 lg:pt-2 lg:pr-2 lg:pl-[355px]">
        <div className="p-6 grow lg:rounded-lg lg:bg-white lg:p-10 lg:ring-1 lg:shadow-xs lg:ring-zinc-950/5 dark:lg:bg-zinc-900 dark:lg:ring-white/10">
